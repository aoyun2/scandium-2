...
bot.on("message", async (message) => {
	...
	if (!message.bot && message.channel.topic && message.channel.topic.includes("93a803f0-385d-495c-a5c1-b73c9bff975d")) {
	...
	if (!message.bot && content.includes(prefix) /*|| message.author.bot*/) { return; }
	//console.log(message);
